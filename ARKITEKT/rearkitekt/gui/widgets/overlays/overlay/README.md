...
```
rearkitekt/gui/widgets/overlays/
├── overlay/
...
See `rearkitekt/gui/widgets/overlays/batch_rename_modal.lua` for complete implementation.
...
- **Batch Rename Modal**: `rearkitekt/gui/widgets/overlays/batch_rename_modal.lua`
...
- **Container**: `rearkitekt/gui/widgets/overlays/overlay/container.lua`
