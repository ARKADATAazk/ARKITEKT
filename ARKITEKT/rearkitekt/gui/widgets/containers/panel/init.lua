...
local Header = require('rearkitekt.gui.widgets.containers.panel.header')
local Content = require('rearkitekt.gui.widgets.containers.panel.content')
local Background = require('rearkitekt.gui.widgets.containers.panel.background')
local TabAnimator = require('rearkitekt.gui.widgets.containers.panel.tab_animator')
...
local function draw_sidebar(ctx, dl, x, y, width, height, sidebar_cfg, panel_id, side)
  ...
  elseif valign == "bottom" then
    start_y = y + height - pad_bottom - total_btn_height
  else -- center
