-- @noindex
-- rearkitekt/gui/widgets/media_grid/init.lua
...
-- Example usage:
--[[
  local MediaGrid = require('rearkitekt.gui.widgets.media.media_grid')
  local AudioGridFactory = require('rearkitekt.gui.widgets.media.media_grid.factories.audio')
...
M.renderers = {}
M.renderers.base = require('rearkitekt.gui.widgets.media.media_grid.renderers.base')
