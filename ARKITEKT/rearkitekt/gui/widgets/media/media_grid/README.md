...
```lua
local MediaGrid = require('rearkitekt.gui.widgets.media_grid')
...
Works seamlessly with `rearkitekt.gui.widgets.grid.core`:
...
1. **Extraction** - Common functionality extracted to rearkitekt
...
- `rearkitekt.gui.widgets.grid.core` - Grid layout system
- `rearkitekt.gui.fx.tile_fx` - Tile visual effects
- `rearkitekt.gui.fx.marching_ants` - Selection animation
