...
--[[
  ...
  local AudioGridFactory = require('rearkitekt.gui.widgets.media_grid.factories.audio')
...
M.renderers = {}
M.renderers.base = require('rearkitekt.gui.widgets.media_grid.renderers.base')
