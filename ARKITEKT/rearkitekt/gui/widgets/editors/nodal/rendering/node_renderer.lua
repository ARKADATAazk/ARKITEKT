-- @noindex
-- ReArkitekt/gui/widgets/nodal/rendering/node_renderer.lua
...
function M.render(ctx, node, animator, config)
  ...
  local chip_color = require('rearkitekt.gui.widgets.editors.nodal.core.node').get_base_color(node, config)
