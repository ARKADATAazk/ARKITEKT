...
local panel_config = {
  ...
  overlay_toolbars = {
    ...
    top = {
      ...
      edge_slide_distance = 0,  -- TEMP: disabled to debug visibility
      bg_color = 0xFF0000AA,  -- TEMP: red background to see it
      auto_hide = {
        enabled = false,  -- TEMP: always visible
        trigger = "hover",
        visible_amount = 1.0,
        animation_speed = 0.2,
      },
    ...
    bottom = {
      ...
      extend_from_edge = true,
      edge_slide_distance = 0,  -- TEMP: disabled to debug visibility
      bg_color = 0x00FF00AA,  -- TEMP: green background to see it
      auto_hide = {
        enabled = false,  -- TEMP: always visible
        trigger = "hover",
        visible_amount = 1.0,
