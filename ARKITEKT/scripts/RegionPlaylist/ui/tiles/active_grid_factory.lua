    ...
    f2 = function(grid, selected_keys)
      ...
      if #selected_keys == 1 then
        ...
        if rt.show_batch_renamer then
          rt:show_batch_renamer(selected_keys, 'active', {
            on_rename = rt.on_active_batch_rename,
            on_rename_and_recolor = rt.on_active_batch_rename_and_recolor,
            on_recolor = rt.on_active_batch_recolor,
          })
        end
      end
    end,
