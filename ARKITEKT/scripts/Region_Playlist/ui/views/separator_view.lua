-- @noindex
-- Region_Playlist/ui/views/separator_view.lua
-- Draggable separator view for resizing panels
...
local SeparatorView = {}
SeparatorView.__index = SeparatorView
...
function SeparatorView:draw_horizontal(ctx, x, y, width, height, config)
...
function SeparatorView:draw_vertical(ctx, x, y, width, height, config)
  local separator_thickness = config.thickness
...
function SeparatorView:is_dragging()
