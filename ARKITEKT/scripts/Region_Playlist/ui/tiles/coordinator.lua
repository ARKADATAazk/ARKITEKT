...
function M.create(opts)
  ...
  local rt = setmetatable({
    ...
    on_active_rename = opts.on_active_rename,
    on_active_batch_rename = opts.on_active_batch_rename,
    on_active_batch_rename_and_recolor = opts.on_active_batch_rename_and_recolor,
    on_active_batch_recolor = opts.on_active_batch_recolor,
    ...
    on_pool_rename = opts.on_pool_rename,
    on_pool_batch_rename = opts.on_pool_batch_rename,
    on_pool_batch_rename_and_recolor = opts.on_pool_batch_rename_and_recolor,
    on_pool_batch_recolor = opts.on_pool_batch_recolor,
