...
local RegionTiles = require("apps.Region_Playlist.widgets.region_tiles.coordinator")
local Colors = require("arkitekt.core.colors")
local Shortcuts = require("apps.Region_Playlist.app.shortcuts")
local PlaylistController = require("apps.Region_Playlist.app.controller")
local TransportContainer = require("arkitekt.gui.widgets.transport.transport_container")
local Sheet = require("arkitekt.gui.widgets.overlay.sheet")
local ChipList = require("arkitekt.gui.widgets.chip_list.list")
...
function M.create(State, AppConfig, settings)
  ...
  self.layout_button_animator = require('arkitekt.gui.fx.tile_motion').new(Config.ANIMATION.HOVER_SPEED)
