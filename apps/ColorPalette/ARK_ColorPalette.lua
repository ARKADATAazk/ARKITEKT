...
local State = require("apps.ColorPalette.app.state")
local GUI = require("apps.ColorPalette.app.gui")
local OverlayManager = require("arkitekt.gui.widgets.overlay.manager")
