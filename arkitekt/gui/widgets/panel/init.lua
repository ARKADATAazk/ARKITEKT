...
local Header = require('arkitekt.gui.widgets.panel.header')
local Content = require('arkitekt.gui.widgets.panel.content')
local Background = require('arkitekt.gui.widgets.panel.background')
local TabAnimator = require('arkitekt.gui.widgets.panel.tab_animator')
local Scrollbar = require('arkitekt.gui.widgets.controls.scrollbar')
local Config = require('arkitekt.gui.widgets.panel.config')
