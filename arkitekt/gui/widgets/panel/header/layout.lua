...
local COMPONENTS = {
  ...
  search_field = require('arkitekt.gui.widgets.panel.header.search_field'),
  dropdown_field = require('arkitekt.gui.widgets.panel.header.dropdown_field'),
  button = require('arkitekt.gui.widgets.panel.header.button'),
